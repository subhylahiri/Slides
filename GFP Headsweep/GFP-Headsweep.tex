...
\input{units.tex}
\usepackage[type=pdf,controls=none,poster=first]{animate}
...
%
  \begin{center}
    \animategraphics[width=131px,height=98px,loop]
      {10}{Vids/hsa}{}{}\note[item]{accepted}
    \animategraphics[width=131px,height=98px,loop]
      {10}{Vids/hsr}{}{}\note[item]{rejected}
...
\begin{frame}[label=fr_loco]{Locomotion and sensory feedback}%\label{fr_loco}
%
...
%
  ...
  % divide width/height by 8.
    \animategraphics[width=162px,height=162px,loop]
      {4}{Vids/Peristalsis_scaled}{}{}
...
%
  \begin{center}
    \animategraphics[width=315px,height=188px,loop,every=2]
      {4}{Vids/Peristalsis_video}{}{}
...
%
 %
  \begin{center}
    \animategraphics[width=180px,height=180px,loop]
      {8}{Vids/toothpaste}{}{}
 \end{center}
 %
