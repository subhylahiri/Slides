...
\subtitle{\small{based on \href{http://dx.doi.org/10.1371/journal.pone.0023180}{\emph{PLoS
  ONE}, 6:\penalty0e23180, 2011}, with  K.~Shen, M.~Klein, A.~Tang, E.~Kane, M.~Gershow, P.~Garrity, and A.D.T.~Samuel}\nocite{Lahiri2011}}
%
...
%
 Navigation results from combining two basic motor programs: peristalsis and asymmetric contraction. Pathway from sensory input $\to$ motor output simpler than previously thought.
